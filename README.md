# genpark-proptech-leasing-multimodal-inquiry-scheduler-agent-skill
...
> **GenPark AI Agent Skill** -- PropTech conversational leasing agent and tour scheduler (EliseAI style)
